...
<div class="pdf-page-wrapper mb-8 rounded-xl border bg-white overflow-hidden flex" data-page="${i + 1}">
  ...
  <div class="flex-1 min-w-0">
    ...
    const TEXT_EDITOR_JS = [
      ...
      '  if (activeTextEditor) { saveTextEditor(); return }',
      ...
      '  textarea.style.cssText = "position:absolute;left:" + leftPos + "px;top:" + topPos + "px;z-index:9999;min-width:200px;min-height:40px;font-family:\'" + fontFamily + "\';font-size:" + size + "px;color:" + color + ";background:rgba(255,255,255,0.95);border:2px solid #3b82f6;border-radius:4px;padding:6px;outline:none;resize:none;pointer-events:auto;box-shadow:0 2px 8px rgba(0,0,0,0.2)"',
      ...
      '  activeTextEditor = { textarea: textarea, page: page, canvasX: x, canvasY: y, color: color, size: size, fontFamily: fontFamily }',
      '  setTimeout(function() { textarea.focus() }, 50)',
      '  textarea.addEventListener("blur", function() { setTimeout(function() { saveTextEditor() }, 100) })',
      '  textarea.addEventListener("keydown", function(e) {',
      '    if (e.key === "Enter" && !e.shiftKey) { e.preventDefault(); saveTextEditor() }',
