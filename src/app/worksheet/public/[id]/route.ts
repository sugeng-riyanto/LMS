...
<div class="pdf-page-wrapper mb-8 rounded-xl border bg-white overflow-hidden flex" data-page="${i + 1}">
  ...
  <div class="flex-1 min-w-0">
    ...
    const TEXT_EDITOR_JS = [
      ...
      '  textarea.style.cssText = "position:absolute;left:" + leftPos + "px;top:" + topPos + "px;z-index:9999;width:200px;height:60px;font-family:\'" + fontFamily + "\';font-size:" + size + "px;color:" + color + ";background:rgba(255,255,255,0.95);border:2px solid #3b82f6;border-radius:4px;padding:6px;outline:none;resize:both;pointer-events:auto;box-shadow:0 2px 8px rgba(0,0,0,0.2);overflow:auto"',
